# SkyFlow Pro - Dashboard Pemantauan Cuaca

SkyFlow Pro adalah aplikasi dashboard pemantauan cuaca modern berbasis React + Vite. Aplikasi ini menyajikan data meteorologi real time dari seluruh Indonesia secara langsung serta peta satelit radar cuaca.

## Fitur Utama

- **Dashboard Cuaca Real time**: Menyajikan informasi suhu, deskripsi cuaca, suhu, kelembapan, kecepatan angin, tekanan udara, visibilitas, serta waktu terbit & terbenam (format WIB).
